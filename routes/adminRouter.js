...
adminRouter.get('/booking-requests',adminController.getBookingRequests);
adminRouter.post('/booking-approve',adminController.postApproveBooking);
adminRouter.post('/booking-reject',adminController.postRejectBooking);
