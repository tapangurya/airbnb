...
superAdmin.post("/users/toggle/:id", userController.toggleBlockUser);
// Admins
superAdmin.get("/admins", userController.getAdmins);
superAdmin.post("/admins/toggle/:id",userController.toggleBlockAdmin);
// Admin homes
superAdmin.get("/admins/:adminId/homes",userController.getAdminHomes);
superAdmin.post("/admins/:adminId/homes/delete/:homeId",userController.deleteHome);
/* ===================== ACTIVITY LOG ===================== */
superAdmin.get("/activity-log",activityController.getActivityLogs);
